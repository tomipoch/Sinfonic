    ...
    <section className="p-6">
      ...
      <form onSubmit={onSubmit} className="mb-4 flex gap-2">
        <input
          ...
          className="flex-1 rounded-md border border-bg-raised bg-bg-subtle px-3 py-2 text-sm text-fg placeholder:text-fg-muted focus:border-accent focus:outline-none"
        />

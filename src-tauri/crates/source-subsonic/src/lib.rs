//! Subsonic/Navidrome `MusicProvider` (v0.2).
//!
//! Phase 0: skeleton. Real implementation lands in Phase 2 (post-MVP).
...
impl MusicProvider for SubsonicProvider {
    fn identity(&self) -> &Identity {
        unimplemented!("SubsonicProvider::identity — Phase 2")
    }

    fn capabilities(&self) -> &Capabilities {
        unimplemented!("SubsonicProvider::capabilities — Phase 2")
    }

    async fn home_sections(&self) -> ProviderResult<Vec<HomeSection>> {
        Err(ProviderError::Other("Subsonic not implemented in skeleton".into()))
    }
